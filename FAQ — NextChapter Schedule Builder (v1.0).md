...
data saved anywhere outside the device it's used on. Questions marked
**[YOU FILL IN]** need your program's specifics — everything else is
answered by how the app actually works today.
...
[SW Bits, Ltd.](https://www.sw-bits.com)
